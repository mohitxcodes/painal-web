...
const tabs = [
    ...
    { id: 'nature', label: 'Nature', hindiLabel: 'प्रकृति', icon: FaTree },
    { id: 'water', label: 'Water Bodies', hindiLabel: 'जल निकाय', icon: FaWater },
    { id: 'roads', label: 'Roads', hindiLabel: 'सड़कें', icon: FaRoad }
];
